package io.github.jhipster.oauth2.application.config;
...
@Configuration
@EnableMongoRepositories("io.github.jhipster.oauth2.application.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.github.jhipster.oauth2.application.config.dbmigrations");
